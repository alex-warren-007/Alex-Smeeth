...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "তোর বাল") || (event.body.toLowerCase() == "bal")) {
     return api.sendMessage("~ তোমার বাল উঠে নাই নাকি তোমার?? 🤖", threadID);
   };

  if ((event.body.toLowerCase() == "Naim") || (event.body.toLowerCase() == "Naim Vaiya") || (event.body.toLowerCase() == "@Hassan Naim") || (event.body.toLowerCase() == "নাঈম")) {
   ...
   if ((event.body.toLowerCase() == "Admin") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[Admin:☞ Naim ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Naim.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/hassan.naim.802596\nতার সাতে যোগা যোগ করবেন WhatsApp :- 0186974..**", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "সালা আমি তোর বস") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা উল্লাস এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "বালের গ্রুপ") || (event.body.toLowerCase() == "bal er group")) {
     return api.sendMessage("ভালো না লাগলে লিভ নিতে পরো সোনা😚 রাস্তা খোলা আছে..!👀😒😙⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "রিয়াজ") || (event.body.toLowerCase() == "Riyaz")) {
     return api.sendMessage("🥰-রিয়াজ🌺 আমার বস Naim এর বন্ধু লাগে লুচ্চি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };

   if ((event.body.toLowerCase() == "কিস দে") || (event.body.toLowerCase() == "kiss me")) {
   ...
   if ((event.body.toLowerCase() == "তোর নাম কি") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS  °_>Alex☢️Smeeth⚠️ 𝗜𝘀𝗹𝗮𝗺𝗶𝗰𝗸 𝗰𝗵𝗮𝘁 𝗯𝗼𝘁", threadID);
   };

   if ((event.body.toLowerCase() == "বট এর বাচ্চা") || (event.body.toLowerCase() == "Bot er bacca")) {
     return api.sendMessage("️আমার বাচ্চা তো আমার বউ এর পেটে..!!🌚⛏️🌶️ ", threadID);
   };

   if ((event.body.toLowerCase() == "পিক দে") || (event.body.toLowerCase() == "ss daw")) {
     return api.sendMessage("️এন থেকে সর দুরে গিয়া মর😒", threadID);
   };

   if ((event.body.toLowerCase() == "হিজলা") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "মন খারাপ") || (event.body.toLowerCase() == "tmr ki mon kharap")) {
   ...
   if ((event.body.toLowerCase() == "তুমি খাইছো") || (event.body.toLowerCase() == "khaicho")) {
     return api.sendMessage("না জান্স 🥹 তুমি রান্না করে রাখো আমি এসে খাবো <😘", threadID);
   };

   if ((event.body.toLowerCase() == "tumi ki amake bhalobaso") || (event.body.toLowerCase() == "tmi ki amake vlo basho")) {
     return api.sendMessage("হুম জান্স আমি তোমাকে রাইতে ভলোপাসি <🥵", threadID);
   };

   if ((event.body.toLowerCase() == "আমি তোর বস") || (event.body.toLowerCase() == "kire")) {
